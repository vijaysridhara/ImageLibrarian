...
Public Class Category
    Public Sub New(Optional selcat As String = "", Optional selsubcat As String = "")
        ...
        If String.IsNullOrEmpty(selcat) Then
            If cboCat.Items.Count > 0 Then cboCat.SelectedIndex = 0
        Else
            cboCat.SelectedItem = selcat
            If String.IsNullOrEmpty(selsubcat) Then
                If cboSubCat.Items.Count > 0 Then cboSubCat.SelectedIndex = 0
            Else
                cboSubCat.SelectedItem = selsubcat
            End If
        End If
    End Sub
